## Powershell Script for CSR Image
##Intended for Server OS, Windows RDSH, Citrix Virtual Desktop
## Matthew.Franklin
## updated September 2021

#How to call script: Set-ExecutionPolicy Bypass -Scope Process -Force; & '\\SERVER\configs$\vlab-csr-console.ps1'
...
choco upgrade rdm -y
#choco upgrade veeam-backup-and-replication-console -y
choco upgrade sccm-console -y
...
$o365ConfigPath = "\\SERVER\configs$\Office365Pro-CSR-Console-Configuration.xml" 
choco upgrade office365proplus --params "/ConfigPath:$o365ConfigPath" -y

<#
##Exclude Outlook and Teams from CSR Consoles.
...
#Install Office2019
#$o365ConfigPath = "\\SERVER\configs$\csr-console\office2019pp-csr-console.xml" 
#choco upgrade office365proplus --params "/ConfigPath:$o365ConfigPath" -y
#>
