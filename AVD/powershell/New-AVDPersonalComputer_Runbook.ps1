...
$ouPath= "OU=dev,OU=Personal,OU=$($Environment),OU=AVD,OU=CorpClient,OU=Workstations,DC=$($Domain),DC=net"
...
$WebHookURL = "https://prod-30.westus2.logic.azure.com:443/workflows/16c54f67a6a94b71af9fa3cac5ad903b/triggers/manual/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=RdWcr1SIHYc7CsxDfWIl1Ew3uxsYohpyYMt5JWIjUVA"
